...
CREATE TABLE tbitemvenda (
  ...
  KEY FK_CodigoMedicamento_idx (CodigoMedicamento),
  CONSTRAINT FK_CodigoMedicamento FOREIGN KEY (CodigoMedicamento) REFERENCES medicamento (Codigo) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE tbitemcompra (
  ...
  KEY FK_CodigoProduto_idx2 (CodigoMedicamento),
  CONSTRAINT FK_CodigoMedicamento2 FOREIGN KEY (CodigoMedicamento) REFERENCES medicamento (Codigo) ON DELETE NO ACTION ON UPDATE NO ACTION,

 ...
 * @author mende
 */
public class HistCliente extends javax.swing.JFrame {

    /** Creates new form HistCliente */
    public HistCliente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Todosopt.setText("Listar todos os clientes?");
        ...
        jTableList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CPF", "Nome", "Código do remédio", "Descrição remédio"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistCliente().setVisible(true);
            }
        });
    }
